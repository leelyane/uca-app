...
use App\Filament\Resources\EtudiantFSSMResource\Pages;
use App\Filament\Resources\EtudiantFSSMResource\RelationManagers;
...
class EtudiantFSSMResource extends Resource
{
    protected static ?string $model = EtudiantFSSM::class;

    protected static ?string $navigationIcon = 'heroicon-o-user';
    protected static ?string $navigationLabel = 'Étudiant';
    protected static ?string $modelLabel = 'Étudiant';
    protected static ?string $slug = 'fssm-etudiants';
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('confirmer')
                    ...
                    ->action(function (EtudiantFSSM $record) {
                ...
                Tables\Actions\Action::make('rejeter')
                    ...
                    ->action(function (EtudiantFSSM $record) {
                        FSSMDeclinedEtudiant::create($record->toArray());
                        $record->delete();
                    }),
            ])
            ->bulkActions([
    ...
    {
        return [
            'index' => Pages\ListEtudiantFSSMS::route('/'),
            // 'create' => Pages\CreateEtudiantFSSM::route('/create'),
            // 'edit' => Pages\EditEtudiantFSSM::route('/{record}/edit'),
        ];
    }
}
